...
public class FromIpush {  
    ...
    public static void test() {  
        RingBuffer<MyEvent> buffer = RingBuffer.create(ProducerType.MULTI,         //定义一个ringBuffer,也就是相当于一个队列
                new MyEventFactory(), 1 << 2, new BlockingWaitStrategy());
        ...
        WorkerPool<MyEvent> workerPool = new WorkerPool<MyEvent>(buffer,
